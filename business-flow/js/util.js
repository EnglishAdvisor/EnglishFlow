...
(function (root) {
  ...
  DF.VERSION = '1.0.0'; // BUSINESS FLOW
  ...
  // ---------- assinatura FNV dupla (salt exclusivo do BUSINESS FLOW) ----------
  const SALT = 'BF-BUSINESS//subida-ate-a-diretoria//8-andares';
