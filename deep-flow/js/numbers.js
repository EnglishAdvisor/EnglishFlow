/* DEEP FLOW — numbers.js
   Number Talk procedural: números, telefones, part numbers, quantidades e
   unidades (psi, bar, bpd, °C, m³) por listening. Treino infinito.
   Motor reaproveitado do first-oil, reescrito para o DEEP FLOW. */
(function (root) {
  ...
  const UNITS_TALK = [
    { u: 'psi', say: 'p s i', pt: 'libras por polegada²' },
    { u: 'bar', say: 'bar', pt: 'bar' },
    { u: 'bpd', say: 'barrels per day', pt: 'barris por dia' },
    { u: '°C', say: 'degrees Celsius', pt: 'graus Celsius' },
    { u: 'm³', say: 'cubic metres', pt: 'metros cúbicos' },
    { u: 'l/s', say: 'litres per second', pt: 'litros por segundo' },
    { u: 'mm', say: 'millimetres', pt: 'milímetros' },
    { u: 'm', say: 'metres', pt: 'metros' }
  ];

  const PART_PREFIX = ['VLV', 'PD', 'FLG', 'PMP', 'GSK', 'BRG', 'SNS', 'MTR'];
  ...
  N.genItem = function (conf) {
    ...
    if (type === 'part') {
      ...
      return {
        ui: 'type', cat: 'num', srsId: null,
        title: '🏷️ Anote o part number que você ouvir:',
        main: null, tts: useNato ? N.nato(pn) : N.spellPart(pn),
        ttsLabel: '🔊 Ouvir o part number',
