/* LIFE FLOW — numbers.js
   Number Talk procedural: números, telefones, códigos de confirmação,
   quantidades e unidades do dia a dia (%, $, km, kg, min, °C) por listening.
   Motor reaproveitado do DEEP FLOW, adaptado ao cotidiano. */
(function (root) {
  ...
  const UNITS_TALK = [
    ...
    { u: 'years', say: 'years old', pt: 'anos de idade' },
    { u: 'people', say: 'people', pt: 'pessoas' }
  ];

  const PART_PREFIX = ['REF', 'CNF', 'RES', 'ORD', 'APT', 'BUS', 'GTE', 'TCK'];
  ...
  N.genItem = function (conf) {
    ...
    if (type === 'part') {
      ...
      return {
        ui: 'type', cat: 'num', srsId: null,
        title: '🏷️ Anote o código de confirmação que você ouvir:',
